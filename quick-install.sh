...
if ! [[ -d $HOME/GitHub/gentoo-scripts ]] || ! [[ -d $HOME/GitHub/mine/gentoo-scripts ]]; then
  git clone https://github.com/fusion809/gentoo-scripts $HOME/GitHub/mine/gentoo-scripts
  # Copy across
  cp -a $HOME/GitHub/mine/gentoo-scripts/{Shell,.bashrc,.zshrc} $HOME/
  ...
  cd -
  # Copy across
  cp -a $HOME/GitHub/gentoo-scripts/{Shell,.bashrc,.zshrc} $HOME/
